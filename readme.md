...
- **Deep Space Dark Mode:**
  - Atmospheric background imagery with a clean, distraction-free presentation.
...
- **Sandstorm Light Mode:**
  - A calm light theme with readable contrast and responsive layouts.
...
- `scripts.js` - Contains the logic for the Theme Toggle switch, the custom cursor, and the Intersection Observer scrolling animations.
